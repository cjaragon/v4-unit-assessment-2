...
foods.forEach(function (i) {
  return i.calories = (i.carbs * 4) + (i.protein * 4) + (i.fat * 9)
})
...
const blueProducts = saleProducts.filter(i => {
  return i.color.includes('blue')
})
...
const person = {
  name: 'Chris',
  age: 32,
  jobs: ['Prof. jerk', 'Tight Rope Specialist', 'Prof. Big Boy'],
  birthday: function () {
    return this.age++
  },
  favorites: {
